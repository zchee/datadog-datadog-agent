...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/configstore/def v0.58.2 // indirect
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/def v0.59.0 // indirect
