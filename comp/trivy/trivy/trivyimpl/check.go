...
func Factory(store workloadmeta.Component, cfg config.Component) optional.Option[func() trivy.Check] {
	return optional.NewOption(func() trivy.Check {
		return core.NewLongRunningCheckWrapper(&Check{
			CheckBase:         core.NewCheckBase(trivy.CheckName),
