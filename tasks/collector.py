...
BASE_URL = (
    f"https://github.com/open-telemetry/opentelemetry-collector-releases/releases/download/cmd%2Fbuilder%2Fv{OCB_VERSION}/"
)
...
def generate(ctx):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        run_command = f"{binary_path} --verbose --config {config_path} --skip-compilation"
