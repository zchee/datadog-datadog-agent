...
func testTLSAMQPClassification(t *testing.T, tr *Tracer, _, targetHost, serverHost string) {
	...
	cmd, cancel := proxy.NewExternalUnixTransparentProxyServer(t, amqpUnixPath, authority, amqp.AmqpTLS)
	t.Cleanup(cancel)
