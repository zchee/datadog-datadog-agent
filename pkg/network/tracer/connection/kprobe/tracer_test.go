...
func loaderFunc(closeFn func(), err error) func(_ *config.Config, _ manager.Options, _ *perf.EventHandler, _ *perf.EventHandler) (*manager.Manager, func(), error) {
	return func(_ *config.Config, _ manager.Options, _ *perf.EventHandler, _ *perf.EventHandler) (*manager.Manager, func(), error) {
...
func TestCORETracerSupported(t *testing.T) {
	...
	coreCalled := false
	coreTracerLoader = func(*config.Config, manager.Options, *perf.EventHandler, *perf.EventHandler) (*manager.Manager, func(), error) {
		coreCalled = true
		return nil, nil, nil
	}
...
func TestDefaultKprobeMaxActiveSet(t *testing.T) {
	...
	tracerLoaderFromAsset = func(_ bytecode.AssetReader, _, _ bool, _ *config.Config, mgrOpts manager.Options, _ *perf.EventHandler, _ *perf.EventHandler) (*manager.Manager, func(), error) {
