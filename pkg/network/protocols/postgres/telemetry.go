...
const (
	...
	firstBucketLowerBoundary = ebpfpostgres.BufferSize - numberOfBucketsSmallerThanMaxBufferSize*bucketLength + 1
)
...
func (t *Telemetry) Count(tx *ebpfpostgres.EbpfEvent, eventWrapper *EventWrapper) {
