...
BPF_PROG_ARRAY(cgroup_skb_protocols_progs, PROG_MAX)
...
BPF_PROG_ARRAY(cgroup_skb_dispatcher_classification_progs, DISPATCHER_PROG_MAX)
...
BPF_LRU_MAP(tcp_seen_non_splice, __u64, __u32, 2048)
