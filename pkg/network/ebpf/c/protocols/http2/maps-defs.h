...
BPF_HASH_MAP(kprobe_http2_iterations, tls_dispatcher_arguments_t, http2_tail_call_state_t, 0)

BPF_HASH_MAP(sk_msg_http2_iterations, tls_dispatcher_arguments_t, http2_tail_call_state_t, 0)
