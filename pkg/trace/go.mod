...
require (
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.57.0
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.57.0
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.57.0
	...
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.57.0
