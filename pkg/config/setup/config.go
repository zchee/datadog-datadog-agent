...
func InitConfig(config pkgconfigmodel.Config) {
	...
	config.BindEnvAndSetDefault("reverse_dns_enrichment.circuit_breaker.enabled", true)
	config.BindEnvAndSetDefault("reverse_dns_enrichment.circuit_breaker.max_consecutive_failures", 10)
	config.BindEnvAndSetDefault("reverse_dns_enrichment.circuit_breaker.open_duration", 10)
	config.BindEnvAndSetDefault("reverse_dns_enrichment.circuit_breaker.reset_duration", 60)
}
