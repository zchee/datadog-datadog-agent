...
func InitConfig(config pkgconfigmodel.Config) {
	...
	config.BindEnvAndSetDefault("logs_config.multi_line_experiment.token_match_threshold", 0.75) // here
	config.BindEnvAndSetDefault("logs_config.multi_line_experiment.detection_threshold", 0.75)
	config.BindEnvAndSetDefault("logs_config.multi_line_experiment.timestampMatch_threshold", 0.50) // here
