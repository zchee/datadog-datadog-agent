...
import (
	...
	"github.com/DataDog/datadog-agent/pkg/network/protocols/postgrestypes"
...
func InitSystemProbeConfig(cfg pkgconfigmodel.Config) {
	...
	cfg.BindEnvAndSetDefault(join(smNS, "max_postgres_telemetry_buffer"), postgrestypes.BufferSize)
