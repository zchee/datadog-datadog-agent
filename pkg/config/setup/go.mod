...
require (
	...
	github.com/DataDog/datadog-agent/pkg/config/nodetreemodel v0.62.1
	github.com/DataDog/datadog-agent/pkg/config/structure v0.62.1
	github.com/DataDog/datadog-agent/pkg/config/teeconfig v0.62.1
...
require (
	github.com/DataDog/datadog-agent/comp/api/api/def v0.62.1 // indirect
