...
require (
	...
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.56.0
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.56.0
	github.com/DataDog/datadog-agent/comp/serializer/compression v0.56.0
	...
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.56.0
	...
	github.com/DataDog/datadog-agent/pkg/util/json v0.56.0
