...
func newKubernetesEventBundler(ctx context.Context, clusterName string, event *v1.Event) *kubernetesEventBundle {
	return &kubernetesEventBundle{
		...
		hostInfo:            getEventHostInfo(ctx, clusterName, event),
	}
}
