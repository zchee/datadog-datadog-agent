...
require (
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.57.0
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.57.0
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.57.0
