...
require (
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.56.0
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.56.0
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.56.0
