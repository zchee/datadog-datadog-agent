...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/security/secl v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/trace v0.64.0-devel.0.20250129182827-bab631c10d61
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.62.2-rc.1
...
require (
	github.com/DataDog/datadog-agent/comp/api/authtoken v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/impl v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/config/structure v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/defaultpaths v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/utilizationtracker v0.62.2-rc.1
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log/impl v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/log/mock v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/secrets v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/status v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/tagger/origindetection v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/tagger/tags v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/tagger/types v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/def v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/def v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/serializer/compression v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/trace/agent/def v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.62.2-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/api v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/config/env v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/config/remote v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/config/setup v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/config/utils v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/errors v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/status/utils v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/metrics v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/proto v0.63.0-devel.0.20250123185937-1feb84b482c8
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/cache v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/common v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/containers/image v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/executable v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/http v0.62.2-rc.1
	github.com/DataDog/datadog-agent/pkg/util/json v0.62.2-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/system v0.62.2-rc.1
...
replace github.com/DataDog/datadog-api-client-go/v2 => github.com/DataDog/datadog-api-client-go/v2 v2.13.0

replace github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/logs => github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/logs v0.21.0
