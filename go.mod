...
replace github.com/DataDog/datadog-agent/pkg/trace => github.com/DataDog/datadog-agent/pkg/trace v0.59.0-devel.0.20240911192058-0c2181220f85
...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/impl v0.59.0
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.59.0
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.59.0
	github.com/DataDog/datadog-agent/comp/def v0.59.0
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.59.0
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.59.0
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.59.0
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.59.0
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/def v0.59.0
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.59.0
	...
	github.com/DataDog/datadog-agent/comp/otelcol/converter/def v0.59.0
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.59.0
	github.com/DataDog/datadog-agent/comp/serializer/compression v0.59.0
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.59.0
	...
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.59.0
	github.com/DataDog/datadog-agent/pkg/metrics v0.59.0
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.59.0
	...
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.59.0
	...
	github.com/DataDog/datadog-agent/pkg/util/cache v0.59.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/countconnector v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/routingconnector v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/servicegraphconnector v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/spanmetricsconnector v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/loadbalancingexporter v0.113.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatorateprocessor v0.113.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/groupbytraceprocessor v0.113.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/redactionprocessor v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/remotetapprocessor v0.113.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8sclusterreceiver v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8seventsreceiver v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8sobjectsreceiver v0.113.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kubeletstatsreceiver v0.113.0 // indirect
	...
	go.opentelemetry.io/collector/connector/forwardconnector v0.113.0 // indirect
	...
	go.opentelemetry.io/collector/extension/memorylimiterextension v0.113.0 // indirect
	...
	go.opentelemetry.io/contrib/bridges/otelzap v0.7.0 // indirect
	go.opentelemetry.io/contrib/config v0.12.0 // indirect
...
replace go.opentelemetry.io/contrib/config => go.opentelemetry.io/contrib/config v0.9.0
