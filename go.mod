...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/security/secl v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/trace v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.56.0-rc.1
	...
	github.com/DataDog/ebpf-manager v0.7.1-0.20240708194520-b6064c0b8e09
...
require (
	...
	github.com/DataDog/datadog-agent/cmd/agent/common/path v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/comp/core/secrets v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/core/status v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/converter/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/converter/impl v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/extension/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/extension/impl v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/serializer/compression v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/trace/agent/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.56.0-rc.1
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/api v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/env v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/logs v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/model v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/remote v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/setup v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/utils v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/errors v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/status/utils v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/metrics v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/proto v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/cache v0.56.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/common v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/json v0.56.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/util/system v0.56.0-rc.1
...
replace (
	...
	github.com/aquasecurity/trivy => github.com/DataDog/trivy v0.0.0-20240701170153-3090480eda42
